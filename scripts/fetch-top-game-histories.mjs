...
const SEARCH_ALIASES = {
  ...
  'The Adventures of Robin Hood': 'The Adventures of Robin Hood (video game)',
  'Barbarian 2': 'Barbarian II: The Dungeon of Drax',
  'Battle Isle': 'Battle Isle (video game)',
  'Black Crypt': 'Black Crypt',
  'Croisière pour un Cadavre': 'Cruise for a Corpse',
  'Dark Seed': 'Dark Seed (video game)',
  'Desert Strike': 'Desert Strike',
  Drakkhen: 'Drakkhen',
  Extase: 'Extase (video game)',
  'F/A-18 Interceptor': 'F/A-18 Interceptor',
  'Faery Tale Adventure, The': 'The Faery Tale Adventure',
  Flood: 'Flood (video game)',
  'The Godfather': 'The Godfather (1991 video game)',
  'Great Courts 2': 'Great Courts 2',
  Heimdall: 'Heimdall (video game)',
  'Marble Madness': 'Marble Madness',
  'Maupiti Island': 'Maupiti Island',
  'Operation Stealth': 'Operation Stealth',
  Putty: 'Putty (video game)',
  'Robocop 3': 'RoboCop 3 (video game)',
  "Ruff 'n' Tumble": "Ruff 'n' Tumble",
  'Soccer Kid': 'Soccer Kid',
  'Teenage Queen': 'Teenage Queen',
  'Les Voyageurs du Temps': 'Future Wars',
};
