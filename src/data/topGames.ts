...
export type RankSourceId = 'lemon' | 'atarimania' | 'taddei';
...
export interface TopGame {
  ...
  ranks: Partial<Record<'lemon' | 'atarimania', number>>;
 ...
 * and David Taddei’s unordered Amiga selection.
 */
export const TOP_GAMES: TopGame[] = [
  { title: 'Monkey Island', platforms: ['amiga', 'atari'], ranks: { lemon: 1, atarimania: 16 }, lists: ['taddei'] },
  { title: 'Turrican 2', platforms: ['amiga', 'atari'], ranks: { lemon: 2, atarimania: 24 }, lists: ['taddei'] },
  { title: 'Monkey Island 2', platforms: ['amiga'], ranks: { lemon: 3 }, lists: [] },
  { title: 'Sensible World of Soccer', platforms: ['amiga'], ranks: { lemon: 4 }, lists: ['taddei'] },
  { title: 'Lemmings', platforms: ['amiga', 'atari'], ranks: { lemon: 5, atarimania: 23 }, lists: ['taddei'] },
  { title: 'The Settlers', platforms: ['amiga'], ranks: { lemon: 6 }, lists: ['taddei'] },
  ...
  { title: 'Cannon Fodder', platforms: ['amiga'], ranks: { lemon: 12 }, lists: ['taddei'] },
  ...
  { title: 'Speedball 2', platforms: ['amiga', 'atari'], ranks: { lemon: 15, atarimania: 14 }, lists: ['taddei'] },
  ...
  { title: 'Pinball Fantasies', platforms: ['amiga'], ranks: { lemon: 20 }, lists: [] },
  { title: 'Worms', platforms: ['amiga'], ranks: { lemon: 21 }, lists: [] },
  { title: 'Pinball Dreams', platforms: ['amiga'], ranks: { lemon: 22 }, lists: ['taddei'] },
  { title: 'Simon the Sorcerer', platforms: ['amiga'], ranks: { lemon: 23 }, lists: [] },
  { title: 'Lotus 2', platforms: ['amiga', 'atari'], ranks: { lemon: 24, atarimania: 61 }, lists: [] },
  { title: 'Wing Commander', platforms: ['amiga'], ranks: { lemon: 25 }, lists: [] },
  { title: 'Eye of the Beholder 2', platforms: ['amiga', 'atari'], ranks: { lemon: 26 }, lists: [] },
  { title: 'The Chaos Engine', platforms: ['amiga', 'atari'], ranks: { lemon: 27, atarimania: 26 }, lists: ['taddei'] },
  { title: 'Ruff n Tumble', platforms: ['amiga'], ranks: { lemon: 28 }, lists: ['taddei'] },
  { title: 'Colonization', platforms: ['amiga'], ranks: { lemon: 29 }, lists: [] },
  { title: 'It Came from the Desert', platforms: ['amiga', 'atari'], ranks: { lemon: 30 }, lists: ['taddei'] },
  { title: 'Dragon Wars', platforms: ['amiga'], ranks: { lemon: 31 }, lists: [] },
  { title: 'Battle Squadron', platforms: ['amiga'], ranks: { lemon: 32 }, lists: ['taddei'] },
  ...
  { title: 'Dune', platforms: ['amiga'], ranks: { lemon: 45 }, lists: ['taddei'] },
  ...
  { title: 'Turrican', platforms: ['amiga', 'atari'], ranks: { lemon: 48, atarimania: 65 }, lists: [] },
  ...
  { title: 'Lotus', platforms: ['amiga', 'atari'], ranks: { lemon: 51, atarimania: 12 }, lists: ['taddei'] },
  { title: 'Pinball Illusions', platforms: ['amiga'], ranks: { lemon: 52 }, lists: [] },
  { title: 'Populous 2', platforms: ['amiga', 'atari'], ranks: { lemon: 53, atarimania: 60 }, lists: [] },
  { title: 'Super Cars 2', platforms: ['amiga', 'atari'], ranks: { lemon: 54 }, lists: ['taddei'] },
  { title: 'Superfrog', platforms: ['amiga'], ranks: { lemon: 55 }, lists: ['taddei'] },
  ...
  { title: 'Agony', platforms: ['amiga'], ranks: { lemon: 60 }, lists: ['taddei'] },
  { title: 'Apidya', platforms: ['amiga'], ranks: { lemon: 61 }, lists: ['taddei'] },
  { title: 'Project-X', platforms: ['amiga'], ranks: { lemon: 62 }, lists: ['taddei'] },
  { title: 'SWIV', platforms: ['amiga', 'atari'], ranks: { lemon: 63, atarimania: 64 }, lists: ['taddei'] },
  { title: 'Xenon 2', platforms: ['amiga', 'atari'], ranks: { lemon: 64, atarimania: 13 }, lists: ['taddei'] },
  { title: 'Gods', platforms: ['amiga', 'atari'], ranks: { lemon: 65, atarimania: 25 }, lists: ['taddei'] },
  { title: 'Alien Breed', platforms: ['amiga'], ranks: { lemon: 66 }, lists: ['taddei'] },
  ...
  { title: 'Hired Guns', platforms: ['amiga'], ranks: { lemon: 73 }, lists: [] },
  ...
  { title: 'Jim Power', platforms: ['amiga', 'atari'], ranks: { lemon: 86 }, lists: ['taddei'] },
  ...
  { title: 'Blood Money', platforms: ['amiga', 'atari'], ranks: { atarimania: 47 }, lists: [] },
  { title: 'Vroom', platforms: ['amiga', 'atari'], ranks: { atarimania: 48 }, lists: ['taddei'] },
  { title: 'No Second Prize', platforms: ['amiga', 'atari'], ranks: { atarimania: 49 }, lists: ['taddei'] },
  { title: 'Lethal Xcess', platforms: ['amiga', 'atari'], ranks: { atarimania: 50 }, lists: [] },
  { title: 'Wings of Death', platforms: ['amiga', 'atari'], ranks: { atarimania: 51 }, lists: [] },
  ...
  { title: 'Lotus 3', platforms: ['amiga'], ranks: { atarimania: 62 }, lists: [] },
  { title: 'Shadow of the Beast', platforms: ['amiga', 'atari'], ranks: { atarimania: 66 }, lists: ['taddei'] },
  ...
  { title: 'Assassin', platforms: ['amiga'], ranks: {}, lists: [] },
  ...
  { title: 'Shadow of the Beast 2', platforms: ['amiga', 'atari'], ranks: {}, lists: [] },
  { title: 'Shadow of the Beast 3', platforms: ['amiga'], ranks: {}, lists: [] },
  { title: 'Turrican 3', platforms: ['amiga'], ranks: {}, lists: [] },
  ...
  { title: 'The Faery Tale Adventure', platforms: ['amiga'], ranks: {}, lists: ['taddei'] },
...
if (TOP_GAMES.length !== 237) {
  throw new Error(`TOP_GAMES must contain 237 entries, got ${TOP_GAMES.length}`);
}
